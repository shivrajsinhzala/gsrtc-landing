...
export const ui = {
  "en": {
    ...
    "guideChipTimetable": "GSRTC bus timetable",
    "guideChipPnr": "Track by PNR",
    "guideChipVolvo": "Volvo & AC buses",
    "guideChipAlerts": "Arrival alerts",
    "guideChipDelay": "Is my bus late?",
    "guideChipCrowd": "How full is my bus?",
    ...
    "q5": "Is it free?",
    "a5": "Yes, completely free. No subscription, no account, and no login required. It is run as a public utility for Gujarat commuters.",
  ...
  "gu": {
    ...
    "adLabel": "જાહેરાત",
    "guideChipTimetable": "GSRTC બસ સમયપત્રક",
    "guideChipPnr": "PNR થી ટ્રેક કરો",
    "guideChipVolvo": "Volvo અને AC બસ",
    "guideChipAlerts": "પહોંચવાના અલર્ટ",
    "guideChipDelay": "મારી બસ મોડી છે?",
    "guideChipCrowd": "મારી બસમાં કેટલી ભીડ છે?",
    ...
    "q5": "શું તે મફત છે?",
    "a5": "હા, સંપૂર્ણ મફત. કોઈ સબસ્ક્રિપ્શન નથી અને ખાતું બનાવવાની જરૂર નથી. તે ગુજરાતના મુસાફરો માટે જાહેર સેવા તરીકે ચલાવાય છે.",
